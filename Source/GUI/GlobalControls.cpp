...
void GlobalControls::resized()
{
    ...
    flexBox.items.add(juce::FlexItem(bypass2).withFlex(1.f));
    flexBox.items.add(deadSpace.withFlex(3.f));
    flexBox.items.add(juce::FlexItem(bypassFilter).withFlex(1.f));
    flexBox.items.add(juce::FlexItem(globalGain).withFlex(1.f));
    flexBox.items.add(juce::FlexItem(outMeter[0]).withFlex(.5));
    flexBox.items.add(juce::FlexItem(outMeter[1]).withFlex(.5));
